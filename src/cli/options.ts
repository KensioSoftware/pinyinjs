/**
 * Turning flags into the options objects each part of the library takes.
 *
 * A flag is a string off a command line and an option is a typed value with a
 * default; this is the whole of the conversion between them, including the
 * refusal when a flag names something that does not exist.
 */
