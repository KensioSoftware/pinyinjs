 ...
 */
const COMPLETE: Path = { steps: [], score: 0 };
 ...
 */
function rangesOf(steps: readonly Step[]): readonly MatchRange[] {
 ...
 */
function contextOf(dictionary: Dictionary, haystack: string): Context {
