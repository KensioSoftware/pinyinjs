...
const SOUND: readonly DictionaryEntry[] = [
  ...
  entry("保安", "bǎo ān", { isProperNoun: true, partOfSpeech: "nz" }),
  entry("京都", "jīng dū", { isProperNoun: true, partOfSpeech: "ns" }),
  entry("三亚", "sān yà", {
    hant: "三亞",
    isProperNoun: true,
    partOfSpeech: "ns",
  ...
  entry("三门峡", "sān mén xiá", {
    hant: "三門峽",
    isProperNoun: true,
    partOfSpeech: "ns",
  }),
  entry("长寿", "cháng shòu", { hant: "長壽", partOfSpeech: "ns" }),
  entry("友谊", "yǒu yì", { hant: "友誼", partOfSpeech: "nr" }),
  entry("温泉", "wēn quán", { hant: "溫泉", partOfSpeech: "nr" }),
