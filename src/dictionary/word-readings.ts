...
export const WORD_READINGS: readonly BuildAssertion[] = [
  ...
  reads("一个", "yī gè", "个 counting is written with its tone"),
  reads("那个人", "nà ge rén", "and 那个's 轻声 holds inside a longer key"),
  reads("独自个", "dú zì gě", "while 个's other reading is not the 量词"),
