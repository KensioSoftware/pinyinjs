/**
 * The bopomofo symbols themselves, as tables.
 *
 * Split from the writing so that each is one thing: this says which symbol
 * stands for which part of a syllable, and `bopomofo-symbols.ts` puts them
 * together.
 */
